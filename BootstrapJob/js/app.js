...
function submenu(){
    ...
    //Header
    document.getElementById("d1").innerHTML="<p class='blinky'>"+myPlayer.name+" selected</p><br>";

    //Options    
    document.getElementById("d2").innerHTML="<a href='javascript:renamePlayer();'>Rename player</a>";
    document.getElementById("d3").innerHTML="<a href='javascript:deletePlayer();'>Delete player</a>";
    document.getElementById("d4").innerHTML="<a href='javascript:resetGames();'>Reset games</a>";
    document.getElementById("d5").innerHTML="<a href='javascript:playGame();'>Play</a>"; 
}
